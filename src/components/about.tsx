  ...
  return (
    <section className="portfolio-about">
      ...
      <div className="portfolio-about-text">
        <p>
          I am full stack developer skilled with react library, react native
          framework, typescript for frontend and for backend i use node.js and
          express.js. I love food, gym, reading and learning new computer
          related stuff.
        </p>
      </div>
    </section>
